...
For detailed information, see descriptions about [createEngine](../api/Android/v2.7.0/function.html#thunderenginecreateengine), [createWithLoop](../api/Android/v2.7.0/function.md#thunderenginecreatewithloop), and [setArea](../api/Android/v2.7.0/function.md#thunderenginesetarea).

When creating ThunderEngine, you need to monitor SDK events and status callback through [ThunderEventHandler](../api/Android/v2.7.0/notification.md#thundereventhandler) as required by the scenario. For example:

- Token status: [onTokenWillExpire](../api/Android/v2.7.0/notification.md#thundereventhandlerontokenwillexpire):

```java
public void onTokenWillExpire() {}
```

- Network status: [onConnectionStatus](../api/Android/v2.7.0/notification.md#thundereventhandleronconnectionstatus):

```java
public void onConnectionStatus(){}
```

- Publishing callback for remote users: [onRemoteVideoStopped](../api/Android/v2.7.0/notification.md#thundereventhandleronremotevideostopped)

```java
public void onRemoteVideoStopped(String uid, boolean stop) {}
```

You can process callback interfaces in ThunderEventHandler based on scenario requirements. For details, see [API Document](../api/Android/v2.7.0/category.md).
...
For detailed information, see descriptions about [setMediaMode](../api/Android/v2.7.0/function.html#thunderenginesetmediamode), [setRoomMode](../api/Android/v2.7.0/function.html#thunderenginesetroommode), and [joinRoom](../api/Android/v2.7.0/function.html#thunderenginejoinroom) in API Document.
...
For detailed information, see descriptions about [setLocalVideoCanvas](.../api/Android/v2.7.0/function.html#thunderenginesetlocalvideocanvas) and [startVideoPreview](../api/Android/v2.7.0/function.html#thunderenginestartvideopreview) in API Document.
...
For detailed information, see descriptions about [stopLocalVideoStream](../api/Android/v2.7.0/function.html#thunderenginestoplocalvideostream) in API Document.StopLocalVideoStream can only be called after receiving the callback of onJoinRoomSuccess.
...
For detailed information, see descriptions about [stopLocalVideoStream](../api/Android/v2.7.0/function.html#thunderenginestoplocalvideostream) and [stopVideoPreview](../api/Android/v2.7.0/function.html#thunderenginestopvideopreview) in API Document.
...
For detailed information, see descriptions about [setVideoEncoderConfig](../api/Android/v2.7.0/function.html#thunderenginesetvideoencoderconfig) in API Document.

### 4.5 Receiving and Displaying Remote Video

If another user is publishing in the room where the local user resides, the local user will receive event callback of [onRemoteVideoStopped](../api/Android/v2.7.0/notification.html#thundereventhandleronremotevideostopped) in the callback of ThunderEventHandler:
...
For detailed information, see descriptions about [setRemoteVideoCanvas](../api/Android/v2.7.0/function.html#thunderenginesetremotevideocanvas) in API Document.

### 4.6 Leaving the Channel

To stop a call, disable the app, or switch the app to the background, and call [leaveRoom](../api/Android/v2.7.0/function.html#thunderengineleaveroom) to leave the current call channel.
...
- [createEngine](../api/Android/v2.7.0/function.html#thunderenginecreateengine)
- [createWithLoop](../api/Android/v2.7.0/function.html#thunderenginecreatewithloop)
- [joinRoom](../api/Android/v2.7.0/function.html#thunderenginejoinroom)
- [setArea](../api/Android/v2.7.0/function.html#thunderenginesetarea)
- [setSceneId](../api/Android/v2.7.0/function.html#thunderenginesetsceneid)
- [setMediaMode](../api/Android/v2.7.0/function.html#thunderenginesetmediamode)
- [setRoomMode](../api/Android/v2.7.0/function.html#thunderenginesetroommode)
- [setLocalVideoCanvas](../api/Android/v2.7.0/function.html#thunderenginesetlocalvideocanvas)
- [setVideoEncoderConfig](../api/Android/v2.7.0/function.html#thunderenginesetvideoencoderconfig)
- [startVideoPreview](../api/Android/v2.7.0/function.html#thunderenginestartvideopreview)
- [stopVideoPreview](../api/Android/v2.7.0/function.html#thunderenginestopvideopreview)
- [setRemoteVideoCanvas](../api/Android/v2.7.0/function.html#thunderenginesetremotevideocanvas)
- [leaveRoom](../api/Android/v2.7.0/function.html#thunderengineleaveroom)
- [destroyEngine](../api/Android/v2.7.0/function.html#thunderenginedestroyengine)
