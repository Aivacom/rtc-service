...
| Name | Description |
| :--- | :--- |
| token | For the requirements of authentication, see [Authentication Access Manual](/rtc-service/rtc_video_interaction/token_generator/token_generator.md) for details |
...
Token is used for business authentication. The format is suggested as follows. See [Authentication Access Manual](/rtc-service/rtc_video_interaction/token_generator/token_generator.md) for detail
...
| Parameter | Description |
| :--- | :--- |
| token | For requirements of authentication, refer to "[User Authentication Description](/rtc-service/rtc_video_interaction/token_generator/token_generator.md)" for detail |
